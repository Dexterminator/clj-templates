...
(defn about []
  [:div.about
   [:div.question "What is clj-templates?"]
   [:div.answer "A search engine for Clojure project templates. The templates are
   ...
   [:div.answer
    "The icons on the search results (" [lein-logo] " for "
   ...
   [:div.question "I found a bug/I have a suggestion, where do I send it?"]
   [:div.answer "You can create a GitHub issue " [:a {:href "https://github.com/Dexterminator/clj-templates/issues"} "here"] "."]])
